...
import { collection, query, orderBy, doc, setDoc, deleteDoc, getDocs, where } from "firebase/firestore"
    ...
    async function setProjects() {
     ...
     //VUEX version
      ...
      if (that.recent == true) {
        ...
        alert("longest")
        var snapshot = query(collection(db, "Project"),  where('Status', "not-in", ["closed", "completed"]), orderBy("Project_End"));
        alert("shortest")
