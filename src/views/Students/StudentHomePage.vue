      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <div class="carouContainer">
            <div
              :key="item.key"
              v-for="(item, key) in testCollection.slice(12)"
            >
              <Card
                v-if="key <= 5"
                :apply="true"
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <div class="carouContainer">
            <div
              :key="item.key"
              v-for="(item, key) in wholeTestCollection.slice(6)"
            >
              <Card
                v-if="key <= 5"
                :apply="true"
        ...
        <div class="carousel-item">
          <div class="carouContainer">
            <div
              :key="item.key"
              v-for="(item, key) in wholeTestCollection.slice(12)"
            >
              <Card
                v-if="key <= 5"
                :apply="true"
  ...
  mounted() {
    ...
    async function fetchProject() {
      ...
      const projects = query(
        ...
        where("Tags", "array-contains-any", returnArray),
        where("Status", "==", "open")
      );
      let snapshot = await getDocs(projects);
      const projects2 = query(
        collection(db, "Project"),
        where("Status", "==", "open")
      );
